...
namespace StellaKFCPlugin.EF
{
    public class StellaKFCContext : DbContext
    {
        ...
        {
            var config = new ConfigurationBuilder().AddJsonFile(Path.Combine(Directory.GetCurrentDirectory(), "plugins", "plugin_kfc.json")).Build();
            var coreConfig = config.Get<StellaKFCPluginConfig>();
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<SvProfile>(entity =>
            {
                ...
                entity.HasIndex(e => e.RefId, "refid").IsUnique();
